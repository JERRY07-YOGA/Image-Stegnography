...
class SteganographyApp:
    def __init__(self, master):
        ...
        master.configure(bg="black")  # Full black background

        # Title Label with Hacker Style
        ...
        self.encode_frame = tk.Frame(self.notebook, bg="black")  # Ensure black background
        self.notebook.add(self.encode_frame, text="Encode")

        self.decode_frame = tk.Frame(self.notebook, bg="black")  # Ensure black background
    ...
    def encode(self):
        ...
        try:
            ...
            # Call encoding function (needs implementation)
    ...
    def decode(self):
        ...
        try:
            img = Image.open(image_path)
            # Call decoding function (needs implementation)
            # decoded_message = self.decode_message(img)
            decoded_message = "Fake secret message (function not implemented yet)"
